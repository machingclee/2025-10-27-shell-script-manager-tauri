...
export const UpsertAIProfileDialog = (props: {
    isOpen: boolean;
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            >
                <DialogHeader>
                    <DialogTitle>{profile ? "Edit AI Profile" : "Create AI Profile"}</DialogTitle>
                    <DialogDescription>
                        {profile ? "Update the profile information." : "Create a new AI profile."}
                    </DialogDescription>
                </DialogHeader>
