...
export const UpsertModelConfigDialog = (props: {
    isOpen: boolean;
    ...
    const handleSave = () => {
        let openAiConfig: OpenAiModelConfigDTO | undefined;
        let azureConfig: AzureModelConfigDTO | undefined;
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen} key={isOpen ? "open" : "closed"}>
            ...
            >
                <DialogHeader>
                    <DialogTitle>
                        {modelConfig ? "Edit Model Config" : "Create Model Config"}
                    </DialogTitle>
                    <DialogDescription>
                        {modelConfig
