...
CREATE TABLE "new_application_state" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
INSERT INTO "new_application_state" ("created_at", "created_at_hk", "id", "last_opened_folder_id") SELECT "created_at", "created_at_hk", "id", "last_opened_folder_id" FROM "application_state";
DROP TABLE "application_state";
ALTER TABLE "new_application_state" RENAME TO "application_state";
