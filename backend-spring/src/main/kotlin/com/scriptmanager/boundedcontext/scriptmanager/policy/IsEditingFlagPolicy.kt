...
class IsEditingFlagPolicy : Policy {
    ...
    fun `When we save an item, is_editing should be false`(event: ToBeArrangedEvent) {
    ...
    fun `When we click 'leave anyway', update is_editing to false`(event: ToBeArrangedEvent) {
